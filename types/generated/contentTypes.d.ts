...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    advancePrice: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdByUserID: Schema.Attribute.Relation<
      'oneToOne',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    updateOn: Schema.Attribute.DateTime;
  };
}

export interface ApiTypeCurrencyTypeCurrency
  extends Struct.CollectionTypeSchema {
...
export interface ApiTypePaymentTypePayment extends Struct.CollectionTypeSchema {
  collectionName: 'type_payments';
  info: {
    description: '';
    displayName: 'TypePayments';
    pluralName: 'type-payments';
    singularName: 'type-payment';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::type-currency.type-currency': ApiTypeCurrencyTypeCurrency;
      'api::type-payment.type-payment': ApiTypePaymentTypePayment;
